...
export const DASHBOARD_CONFIG = {
  [ROLES.PATIENT]: {
    ...
    nav: [
      ...
      { id: "assistant", label: "AI Assistant", to: "/dashboard/assistant", icon: Sparkles },
  ...
  [ROLES.ADMIN]: {
    ...
    nav: [
      ...
      { id: "appointments", label: "All Appointments", to: "/dashboard/admin/appointments", icon: CalendarClock },
      { id: "announce", label: "Announce", to: "/dashboard/admin/announce", icon: Megaphone },
      { id: "messages", label: "Messages", to: "/dashboard/messages", icon: MessagesSquare },
